...
// IsPresenceContainer reports whether struct field s is a presence container.
func IsPresenceContainer(s reflect.StructField) bool {
	_, ok := s.Tag.Lookup("presence")
	return ok
}
